...
export function Button({ className, variant = 'primary', children, ...props }) {
  const styles = cx(
    'inline-flex items-center justify-center gap-2 rounded-full px-6 py-3 text-sm font-medium transition duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent-500',
    variant === 'primary'
