export const sceneKeyframes = [
  {
    ...
    ribbon: { pos: [0.25, 0.3, -1.1], rot: [0.1, 0.08, 0.08], scale: 1.03, energy: 0.62 },
  ...
  },
  {
    ...
    ribbon: { pos: [1, 0.38, -1.35], rot: [0.22, 0.35, -0.14], scale: 1.08, energy: 0.78 },
  ...
  },
  {
    ...
    ribbon: { pos: [0.5, 0.05, -1.45], rot: [0.06, 0.58, 0.14], scale: 0.97, energy: 0.52 },
  ...
  },
  {
    ...
    ribbon: { pos: [0.2, -0.05, -0.9], rot: [-0.12, 0.92, 0.02], scale: 1.1, energy: 0.74 },
  ...
  },
  {
    ...
    ribbon: { pos: [0.38, 0.12, -1.05], rot: [0.04, 1.12, -0.03], scale: 0.98, energy: 0.46 },
  ...
  },
  {
    ...
    ribbon: { pos: [0.32, -0.18, -1.02], rot: [0.02, 1.45, -0.01], scale: 0.88, energy: 0.3 },
